...
#define MODULE_MQTT_PRINTER_ONLINE_TIMEOUT_SEC  (10)
...
typedef enum {
    ...
    MODULE_MQTT_STATE_PRINTER_ONLINE,
    MODULE_MQTT_STATE_PRINTER_OFFLINE,
}module_mqtt_state_t;
...
typedef enum {
    ...
    MODULE_MQTT_NOTIFICATION_PRINTER_ONLINE,
    MODULE_MQTT_NOTIFICATION_PRINTER_OFFLINE,
