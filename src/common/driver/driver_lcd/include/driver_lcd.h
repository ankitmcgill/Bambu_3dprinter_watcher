...
typedef enum {
    ...
    DRIVER_LCD_COMMAND_SET_SCREEN1_LABEL_LAYER_ACTUAL,
    DRIVER_LCD_COMMAND_SET_SCREEN1_LABEL_LAYER_TARGET,
    DRIVER_LCD_COMMAND_SET_SCREEN1_PROGRESS,
    DRIVER_LCD_COMMAND_SET_SCREEN1_LABEL_TIME_REMAINING,
