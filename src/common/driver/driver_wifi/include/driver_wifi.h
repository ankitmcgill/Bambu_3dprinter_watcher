...
typedef enum {
    ...
    DRIVER_WIFI_COMMAND_AP_BROADCAST
...
typedef enum{
    ...
    DRIVER_WIFI_NOTIFICATION_APSTARTED,
    DRIVER_WIFI_NOTIFICATION_AP_STA_CONNECTED,
    DRIVER_WIFI_NOTIFICATION_AP_STA_DISCONNECTED
